...
def points_to_secret_int(points, prime=None, isecc=0):
    ...
    free_coefficient, lagrange_coefficients = modular_lagrange_interpolation(0, points, prime, isecc)
    # secret_int = free_coefficient  # the secret int is the free coefficient
    return free_coefficient, lagrange_coefficients
